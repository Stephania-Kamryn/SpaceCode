...
function openModal(topic) {
    ...
    if (topic === "Chandrayan-3") {
        content.innerHTML = `
        <h2 class="text-3xl mb-4">Chandrayaan-3</h2>
        <p class="mb-4">
        ...
        content.innerHTML = `
        <h2 class="text-3xl mb-4">James Webb Space Telescope (JWST)</h2>
        <p class="mb-4">
        ...
        content.innerHTML = `
        <h2 class="text-3xl mb-4">Voyager Missions</h2>
        <p class="mb-4">
        ...
        content.innerHTML=`
        <h2 class="text-3xl mb-4">Satellite Orbit Tracker</h2>
        <p class="mb-4">
